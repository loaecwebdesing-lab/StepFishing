...
function sanitizeSavePayload(raw) {
    ...
    return {
        ...
        ownedOrnaments: Array.isArray(data.ownedOrnaments) ? data.ownedOrnaments : [],
        equippedCosmetic: typeof data.equippedCosmetic === 'string' ? data.equippedCosmetic : 'default',
        equippedOrnament: typeof data.equippedOrnament === 'string' ? data.equippedOrnament : null,
...
function getSavePayload() {
    return sanitizeSavePayload({
        ...
        ownedOrnaments: state.ownedOrnaments || [],
        equippedCosmetic: state.equippedCosmetic || 'default',
        equippedOrnament: state.equippedOrnament || null,
